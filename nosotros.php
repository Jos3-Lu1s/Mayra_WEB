...
<div class="bg-secondary py-5" style="background-image: url('./img/Banner.jpg');">
    ...
    <div class="row gx-5 align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
            <div class="p-0">
                ...
                <p>Mejorar las ventas de la panadería.</p>
                <p>Conseguir más ventas de las estimadas.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row text-center">
        ...
        <div class="col-md-4 py-4">
            ...
            <p class="text-dark text-left">
                Alcanzar unas ventas más del 50 %
            </p>
        </div>   
    </div>
</div>
